...
<html>
<head>
    <title>Welcome to rediscart</title>
    <link rel="stylesheet" href="<c:url value="/static/rediscart-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <h2>Welcome to "rediscart" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/rediscart-items.xml</b> - here you can model your items</li>
            <li><b>resources/rediscart-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/rediscart-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/rediscart-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/rediscart-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
