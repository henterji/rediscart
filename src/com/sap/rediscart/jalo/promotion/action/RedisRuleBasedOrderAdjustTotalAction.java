...
public class RedisRuleBasedOrderAdjustTotalAction extends GeneratedRedisRuleBasedOrderAdjustTotalAction implements JaloOnlyItem
{
	private final static Logger LOG = Logger.getLogger(RedisRuleBasedOrderAdjustTotalAction.class.getName());
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final RedisRuleBasedOrderAdjustTotalAction newOne = (RedisRuleBasedOrderAdjustTotalAction) cl.newInstance();
	...
	protected AbstractPromotionAction deepClone(final SessionContext ctx)
	{
		try
		{
			...
			final ComposedType type = TypeManager.getInstance().getComposedType(RedisRuleBasedOrderAdjustTotalAction.class);
			try
			{
