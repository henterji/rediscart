...
import de.hybris.platform.promotionengineservices.jalo.PromotionActionParameter;
...
public class RedisRuleBasedPotentialPromotionMessageAction extends GeneratedRedisRuleBasedPotentialPromotionMessageAction
		implements JaloOnlyItem
{
	private final static Logger LOG = Logger.getLogger(RedisRuleBasedPotentialPromotionMessageAction.class.getName());
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final RedisRuleBasedPotentialPromotionMessageAction newOne = (RedisRuleBasedPotentialPromotionMessageAction) cl
					.newInstance();
	...
	@Override
	public Collection<PromotionActionParameter> getParameters(final SessionContext ctx)
	{
		return data.getProperty(ctx, PARAMETERS);
	}

	@Override
	public void setParameters(final SessionContext ctx, final Collection<PromotionActionParameter> value)
	{
		data.setProperty(ctx, PARAMETERS, value);
	}
	...
	protected AbstractPromotionAction deepClone(final SessionContext ctx)
	{
		try
		{
			...
			final ComposedType type = TypeManager.getInstance().getComposedType(RedisRuleBasedPotentialPromotionMessageAction.class);
			try
			{
