...
/**
 * This is the extension manager of the Rediscart extension.
 *
 * @author Henter Liu (henterji@163.com)
 */
public class RediscartManager extends GeneratedRediscartManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(RediscartManager.class);
	 ...
	 */
	public static RediscartManager getInstance()
	{
		return (RediscartManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(RediscartConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RediscartManager() // NOPMD
	{
		LOG.debug("constructor of RediscartManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of RediscartManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of RediscartManager called, current tenant: {}", getTenant().getTenantID());
	}
